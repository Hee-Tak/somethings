...
class NaverLogin : AppCompatActivity() {
    ...
    private fun startNaverLogin() {
        ...
        val profileCallback = object : NidProfileCallback<NidProfileResponse> {
            override fun onSuccess(response: NidProfileResponse) {
                ...
                setLayoutState(true)
                Toast.makeText(this@NaverLogin, "네이버 아이디 로그인 성공!", Toast.LENGTH_SHORT).show()
            }

            override fun onFailure(httpStatus: Int, message: String) {
                val errorCode = NaverIdLoginSDK.getLastErrorCode().code
                val errorDescription = NaverIdLoginSDK.getLastErrorDescription()
                Toast.makeText(this@NaverLogin, "errorCode : ${errorCode}\n" + "errorDescription : ${errorDescription}", Toast.LENGTH_SHORT).show()
            }
    ...
    private fun startNaverLogout() {
        ...
        setLayoutState(false)
        Toast.makeText(this@NaverLogin, "네이버 아이디 로그아웃 성공!", Toast.LENGTH_SHORT).show()
    }
